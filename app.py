...
st.title("🧭 TARDOC KI-Abrechnungshelfer – Startseite")

# Animation einfügen: süßer Kompass als GIF
st.image("https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExdWhpNnZxaGRxaGZibGoxbGd6enhlb3U1NWxoZTI3bW1yZWhnY2w0YSZlcD12MV9naWZzX3NlYXJjaCZjdD1n/3ov9k7jQXQ2FznhkCs/giphy.gif", width=150, caption="Hi, ich bin NaviDoc – dein KI-Kompass!")
...
if uploaded_file:
    ...
    # Tab 1: GPT-Freitext als Startseite
    with tab1:
